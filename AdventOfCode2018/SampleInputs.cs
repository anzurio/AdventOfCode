...
namespace AdventOfCode2018
{
    ...
    {
        public static List<string> TheStarsAlignSample = new List<string>();
        public static List<string> TheStarsAlign = new List<string>();

        static SampleInputs()
        {
            FillTheStarsAlignSampleInputs();
        }
        

        private static void FillTheStarsAlignSampleInputs()
        {
            var input =
...
position=<-3,  6> velocity=< 2, -1>";
            ...
            TheStarsAlignSample.AddRange(lines);
